...
\matrix[row sep =5mm,column sep=5mm]{
 &\node(vert1)[start]{}; &\\
 &\node(vert16)[process]{y:=x}; &\\
 &\node(vert15)[process]{z:=1}; &\\
 &\node(vert12)[decision]{$y>0$}; &\\
 &\node(vert11)[process]{z:=z*y}; &\node(vert14)[point]{};\\
 &\node(vert10)[process]{y:=y-1}; &\\
\node(vert13)[point]{}; & &\\
 &\node(vert9)[process]{y:=1}; &\\
 &\node(vert6)[decision]{$x>0$}; &\\
 &\node(vert5)[process]{z:=z*x}; &\node(vert8)[point]{};\\
 &\node(vert4)[process]{x:=x-1}; &\\
\node(vert7)[point]{}; & &\\
 &\node(vert3)[process]{x:=0}; &\\
 &\node(vert2)[stop]{}; &\\
};

\draw [myarrow]  (vert16.south) -- (vert15.north);
\draw [myarrow]  (vert11.south) -- (vert10.north);
\draw [myarrow]  (vert10) |- (vert13);
\draw [myarrow]  (vert13)  |-  (vert12.north);
\draw [myarrow]  (vert12.south)  -- node[sloped,above]{yes}  (vert11.north);
\draw [myarrow]  (vert12.east)  -| node[sloped,above, near start]{no}  (vert14.north);
\draw [myarrow]  (vert15.south) -- (vert12.north);
\draw [myarrow]  (vert14.south) |- (vert9.north);
\draw [myarrow]  (vert5.south) -- (vert4.north);
\draw [myarrow]  (vert4) |- (vert7);
\draw [myarrow]  (vert7)  |-  (vert6.north);
\draw [myarrow]  (vert6.south)  -- node[sloped,above]{yes}  (vert5.north);
\draw [myarrow]  (vert6.east)  -| node[sloped,above, near start]{no}  (vert8.north);
\draw [myarrow]  (vert9.south) -- (vert6.north);
\draw [myarrow]  (vert8.south) |- (vert3.north);
\draw [myarrow]  (vert1.south) -- (vert16.north);
