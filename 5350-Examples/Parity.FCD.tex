...
\matrix[row sep =5mm,column sep=5mm]{
 &\node(vert1)[start]{}; & &\\
 &\node(vert6)[decision]{$!(n=1)$}; & &\\
 &\node(vert5)[decision]{$n\%2=0$}; & &\node(vert8)[point]{};\\
 &\node(vert4)[process]{n:=n/2}; &\node(vert3)[process]{n:=3*n+1}; &\\
\node(vert7)[point]{}; & & &\\
 &\node(vert2)[stop]{}; & &\\
};

\draw [myarrow]  (vert5.south)  -- node[sloped,above]{yes} (vert4.north);
\draw [myarrow]  (vert5.east) -| node[sloped,above ]{no} (vert3.north);
\draw [myarrow]  (vert4) |- (vert7);
\draw [myarrow]  (vert3) |- (vert7);
...
\draw [myarrow]  (vert1.south) -- (vert6.north);
\draw [myarrow]  (vert8.south) |- (vert2.north);
