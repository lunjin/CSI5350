...
\matrix[row sep =5mm,column sep=5mm]{
 &\node(vert1)[start]{}; &\\
 &\node(vert10)[process]{y:=x}; &\\
 &\node(vert9)[process]{z:=1}; &\\
 &\node(vert6)[decision]{$y>0$}; &\\
 &\node(vert5)[process]{z:=z*y}; &\node(vert8)[point]{};\\
 &\node(vert4)[process]{y:=y-1}; &\\
\node(vert7)[point]{}; & &\\
 &\node(vert3)[process]{y:=0}; &\\
 &\node(vert2)[stop]{}; &\\
};

\draw [myarrow]  (vert10.south) -- (vert9.north);
...
\draw [myarrow]  (vert6.east)  -| node[sloped,above]{no}  (vert8.north);
\draw [myarrow]  (vert9.south) -- (vert6.north);
\draw [myarrow]  (vert8.south) |- (vert3.north);
\draw [myarrow]  (vert1.south) -- (vert10.north);
